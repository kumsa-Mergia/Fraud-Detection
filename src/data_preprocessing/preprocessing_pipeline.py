...
class DataPreprocessor:
    ...
    def clean_fraud_data(self):
        ...
        self.ip_country_df["lower_bound_ip_address"] = self.ip_country_df[
            "lower_bound_ip_address"
        ].apply(self.ip_to_int)
        self.ip_country_df["upper_bound_ip_address"] = self.ip_country_df[
        ...
        features_to_keep = (
            ...
            + [
                ...
                if col.startswith(("source_", "browser_", "sex_"))
            ]
            + ["class"]
        )
    ...
    def find_country(self, ip_int):
        match = self.ip_country_df[
            (self.ip_country_df["lower_bound_ip_address"] <= ip_int)
...
if __name__ == "__main__":
    ...
    balanced_df.to_csv(
        "../../data/processed/cleaned_balanced_fraud_data.csv", index=False
    )
